...
\input{src/preliminaries/pre-documentclass.de}
...
\input{src/content/introduction.de}
\input{src/content/chap_two.de}

%noch etwas Fülltext
\blinddocument

\input{src/content/conclusion_and_outlook.de}
