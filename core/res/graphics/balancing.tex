\begin{tikzpicture}[auto, rounded corners=0, x = 1cm, y = 1cm] {%
    ...
    \node [action, below = of src] (reading-in) {Read-in graph and initialize the new \gls{metric}};
    ...
    \node [action, above = of new_metric] (writing) {Write $G_{CH}$ without shortcuts, but with updated new \gls{metric}};
