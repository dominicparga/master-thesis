...
\todo{%
    ...
    Paths are flattened in threads, but all workloads could be flattened at once \rightarrow effort has been put into multithreading and dijkstra-repr-comparison, for which reason this flattening-optimization isn't used
}